...
CREATE TABLE `pageviewlog` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `pageviewlog_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pageviewlog`
--

LOCK TABLES `pageviewlog` WRITE;
/*!40000 ALTER TABLE `pageviewlog` DISABLE KEYS */;
/*!40000 ALTER TABLE `pageviewlog` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-07-16 23:44:44
